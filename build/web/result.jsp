            ...
            <div class="row">
               <div class="col-md-12">
                  <div class="titlepage text_align_center">
                     <h2>Resultats de votre <span class="blue_light">recherche</span></h2>
               ...
               <div class="col-lg-3 col-md-6">
                  <div id="ho_co" class="guarantee-box_main">
                     <div class="guarantee-box text_align_center">
                        <i>
                          <img src="images/OIP.jpg" alt="Description de l'image" height="100pt" width="100pt">

                        </i>
                        <h3><%= voyage.getNomDestination() %></h3>
                        <p>Description :<%= voyage.getDescription() %></p>
                          <p>Debut :<%= voyage.getDebut() %></p>
                            <p>Fin :<%= voyage.getFin() %></p>  
                            <p>Prix :<%= voyage.getPrix() %></p>
            ...
            <div class="row">
               ...
               <div class="col-md-4">
                  <div id="ho_co" class="order-box_main">
                     <div class="order-box text_align_center">
                        <h3>Maldives</h3>
                        <p>STARTING  <span>$950</span> PER PERSON</p>
