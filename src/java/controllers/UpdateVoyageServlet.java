 ...
 * @author SAROBIDY
 */
@WebServlet(name = "UpdateVoyageServlet", urlPatterns = {"/UpdateVoyageServlet"})
public class UpdateVoyageServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
         ...
         ActiviteVoyage a = new ActiviteVoyage(id);
                  try {
                      ...
                      Logger.getLogger(UpdateVoyageServlet.class.getName()).log(Level.SEVERE, null, ex);
                  }
        ...
        else if(request.getParameter("action") != null && request.getParameter("action").equalsIgnoreCase("update"))
        {
         ...
         String idV  = (String) request.getAttribute("idV");
