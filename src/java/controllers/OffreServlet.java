 ...
 * @author SAROBIDY
 */
@WebServlet(name = "OffreServlet", urlPatterns = {"/OffreServlet"})
public class OffreServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("text/html;charset=UTF-8");
            ...
            List<Offre> offres = Offre.recupererOffreDetails();
           ...
           RequestDispatcher dispatcher = request.getRequestDispatcher("offre.jsp");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(OffreServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
